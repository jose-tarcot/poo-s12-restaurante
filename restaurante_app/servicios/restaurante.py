...
class Restaurante:
    def __init__(
        ...
        # Permiten localizar productos y usuarios por clave sin recorrer toda la lista.
        ...
        # Reconstruir índices desde los datos cargados (JSON).
        self._reconstruir_indices()

    # ── ÍNDICES ────────────────────────────────────────────────────────────────

    def _reconstruir_indices(self) -> None:
        """Reconstruye las estructuras auxiliares a partir de las listas principales.
    ...
    def actualizar_producto(
        ...
        producto.tiempo_preparacion = nuevo_tiempo
        producto.stock = nuevo_stock
        # Reconstruir el set porque la categoría puede haber cambiado.
